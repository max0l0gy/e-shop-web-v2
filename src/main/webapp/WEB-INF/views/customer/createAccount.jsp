                    ...
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--4-col">
                            <button id="btn-create-account"
                                    class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">${labelWelcome}</button>
                        </div>

                        <div class="mdl-cell mdl-cell--4-col">&nbsp;</div>
                        <div class="mdl-cell mdl-cell--4-col">&nbsp;</div>
                        <div class="mdl-cell mdl-cell--4-col">
                            <button id="btn-proceed-back"
                                    class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">${labelBack}</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--4-col">
                            <button id="btn-verify-email"
                                    class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">${labelVerifyEmail}</button>
                        </div>
                        <div class="mdl-cell mdl-cell--4-col">&nbsp;</div>

                        <div class="mdl-cell mdl-cell--4-col">&nbsp;</div>
                        <div class="mdl-cell mdl-cell--4-col">
                            <button id="btn-verify-email-back"
                                    class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">${labelBackVerify}</button>
                        </div>
                        <div class="mdl-cell mdl-cell--4-col">&nbsp;</div>
                    </div>
                </div>
