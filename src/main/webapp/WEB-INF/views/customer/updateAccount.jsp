...
<div class="titsonfire-more-section">
    <div class="titsonfire-section-title">Update Account Information</div>
    <div class="titsonfire-card-container mdl-grid">
        ...
        <div id="orders-info">
            ...
            <c:if test="${empty orders}">
                ...
                <div class="mdl-cell mdl-cell--12-col mdl-shadow--1dp" style="padding:10px;">
                    <img src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/72b80c113022029.601fdc86e7615.png"
                         alt="You have no orders yet"/>
                </div>
            </c:if>
        </div>
        <!-- end: customer card -->
