...
<%--        </div>--%>
        ...
        <div class="titsonfire-navigation-container">
            <nav class="titsonfire-navigation mdl-navigation">
                ...
                <a class="mdl-navigation__link mdl-typography--text-uppercase tab-shopping-cart"
                   href="${shoppingCartUrl}">
                    <div class="material-icons mdl-badge mdl-badge--overlap shopping-cart-nav">shopping_cart</div>
                </a>
                <a class="mdl-navigation__link mdl-typography--text-uppercase tab-account" href="${accountUrl}">
