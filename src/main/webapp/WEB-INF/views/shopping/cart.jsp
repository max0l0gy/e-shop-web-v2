...
<div class="titsonfire-more-section">
    <div class="titsonfire-section-title">SHOPPiNG CART</div>
    <div class="titsonfire-card-container mdl-grid">
        ...
        <button id="cart-btn-proceed"
                class="mdl-cell mdl-cell--4-col mdl-cell--4-col-phone mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
